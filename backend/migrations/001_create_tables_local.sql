-- Migration for Local PostgreSQL (without Supabase auth dependencies)
-- Run this in pgAdmin Query Tool on pet_tracking_db database

-- Create auth.users table (simplified for local use)
