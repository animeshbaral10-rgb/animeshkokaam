-- =============================================================================
-- PET TRACKING APP – FULL DATABASE SETUP
-- =============================================================================
-- OPTION A: Using psql
--   1. Create database (connect to postgres):  psql -U postgres -c "CREATE DATABASE pettracker;"
--   2. Run this file on pettracker:            psql -U postgres -d pettracker -f create_pettracker_full.sql
--
-- OPTION B: Using pgAdmin
--   1. Create database: right-click Databases → Create → Database → Name: pettracker
--   2. Open Query Tool, select database "pettracker", paste and run this entire file
-- =============================================================================

-- Create database (run this ONLY when connected to 'postgres' or 'template1')
-- Uncomment and run separately if you use Option A step 1 from command line instead:
-- CREATE DATABASE pettracker;

-- From here on, run while connected to database "pettracker"
-- -----------------------------------------------------------------------------
